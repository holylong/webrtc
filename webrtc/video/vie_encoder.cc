...
int32_t ViEEncoder::RegisterExternalEncoder(webrtc::VideoEncoder* encoder, uint8_t pl_type, bool internal_source)
{
...
void ViEEncoder::SetEncoder(const webrtc::VideoCodec& video_codec,
  ...
  bool success = video_sender_.RegisterSendCodec(&video_codec, number_of_cores_,
...
void ViEEncoder::EncodeVideoFrame(const VideoFrame& video_frame)
{
  ...
  TRACE_EVENT_ASYNC_STEP0("webrtc", "Video", video_frame.render_time_ms(), "Encode");
