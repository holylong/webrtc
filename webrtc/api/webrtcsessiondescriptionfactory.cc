...
void WebRtcSessionDescriptionFactory::OnMessage(rtc::Message* msg) 
{
		...
		{
			LOG(INFO) << "FUNCNAME:" << __FUNCTION__ << "MSG_CREATE_SESSIONDESCRIPTION_SUCCESS";
		...
		{
			rtc::ScopedRefMessageData<rtc::RTCCertificate>* param =static_cast<rtc::ScopedRefMessageData<rtc::RTCCertificate>*>(msg->pdata);
