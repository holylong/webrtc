...
rtc::scoped_refptr<VideoCaptureModule> VideoCaptureImpl::Create(const int32_t id, const char* device_id) {
	LOG(LS_INFO) << "=======>>>>VideoCaptureImpl new rtc::RefCountedObject<VideoCaptureDS>(id)";
